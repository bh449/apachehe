                ...
                >
                  <div className="flex items-start justify-between gap-2">
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="text-xs text-muted-foreground font-mono mt-0.5">{item.part.IPN}</div>
                    </div>
                    <Button
                      variant="ghost"
                      size="sm"
                  ...
                  <div className="flex items-center gap-2" data-no-refocus>
                    ...
                    <Badge variant="secondary" className="text-xs">{item.part.units}</Badge>
                  </div>
                </div>
              ))}
            </div>
